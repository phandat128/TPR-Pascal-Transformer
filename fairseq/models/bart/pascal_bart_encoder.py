...
from fairseq.models.transformer.transformer_encoder import module_name_fordropout
...
class PascalBartEncoderBase(FairseqTagsEncoder):
    def __init__(self, cfg, dictionary, embed_tokens, tags_dictionary, return_fc=False):
        ...
        if cfg.num_encoder_pascal_heads is None:
            self.num_encoder_pascal_heads = [0] * cfg.pascal_encoder_layers
        else:
        ...
        assert len(self.num_encoder_pascal_heads) == cfg.pascal_encoder_layers
