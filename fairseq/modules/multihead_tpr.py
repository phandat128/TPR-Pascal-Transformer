...
class MultiheadTPRAttention(FairseqIncrementalDecoder):
    """Multi-headed attention.

    See "Enriching Transformers with Structured Tensor-Product Representations for Abstractive Summarization" for more details.
    """
